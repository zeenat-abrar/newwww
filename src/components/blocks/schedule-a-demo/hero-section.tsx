...
import { ScheduleDemo } from "@/components/blocks/schedule-a-demo/scheduleDemo";
...
export default function HeroSectionScheduleDemo() {
  return (
    <div
      style={{
      ...
      className="bg-ivindigo-500 py-10 pb-32"
    >
      <div className="xl:max-w-[100rem] xl:mx-auto px-[3%] xl:px-[104px] flex flex-col lg:flex-row items-center justify-between w-full md:gap-12">
        ...
        <div className="flex flex-col items-start w-full lg:w-1/2 gap-8 mb-24 lg:mb-0">
          <h1 className="text-xl font-semibold lg:text-2xl text-white">Unified Data Platform</h1>
            ...
            <div key={ele.heading} className="flex justify-start items-center">
              <div className="flex justify-center gap-5">
                ...
                <div className="flex flex-col items-start">
                  <h1 className="text-white text-base xl:text-xl font-bold">{ele.heading}</h1>
                  <p className="text-gray-50 xl:text-base">{ele.description}</p>
                </div>
              </div>
            </div>
          ))}
